...
image_npy_path = 'data/Pancreas_Segmentation/NPY_Images'
image_path = 'data/Pancreas_Segmentation/train/images'
mask_npy_path = 'data/Pancreas_Segmentation/NPY_Masks'
mask_path = 'data/Pancreas_Segmentation/train/masks'
list_training = {
    'Z': '../data/Pancreas_Segmentation/train/training_Z.txt'
}
...
for plane in list_training:
    directory = os.path.dirname(list_training[plane])
...
for i in range(total_samples):
    ...
    for plane in ['Z']:
        ...
        for j in range(slice_number):
            ...
            with open(list_training[plane], 'a+') as output:
